...
#Norske flagg
scandinavian-flag(color(0, 48, 135,1), color(255, 255, 255,1), color(200, 16, 46,1))

#Danmark flagg
scandinavian-flag(color(255, 255, 255,1), color(255, 255, 255,1), color(198, 12, 48,1))

#Sverige flagg
scandinavian-flag(color(255, 205, 0,1), color(255, 205, 0,1), color(0, 75, 135,1))

#Finske flagg
scandinavian-flag(color(0, 47, 108,1), color(0, 47, 108,1), color(255, 255, 255,1))

#islandske flagg 
scandinavian-flag(color(220, 30, 53,1), color(255, 255, 255,1), color(2, 82, 156,1))
